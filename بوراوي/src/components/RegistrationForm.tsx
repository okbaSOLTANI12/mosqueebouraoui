...
const EMAIL_SERVER_URL = process.env.NEXT_PUBLIC_EMAIL_SERVER_URL || 'http://localhost:3001';
...
const RegistrationForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${EMAIL_SERVER_URL}/api/send-registration`, {
        method: 'POST',
        headers: {
      ...
      >
        <div className="form-header">
          ...
          <p className="form-description">
            يسر مسجد الإمام مالك بالإقامة الجامعية بوراوي عمار الإعلان عن انطلاق دورة لحفظ القرآن الكريم عن بعد عبر تطبيق Telegram، بإشراف مشايخ مؤهلين، وتمتد إلى غاية 1 سبتمبر. يرجى تعبئة هذه الاستمارة بدقة لتنسيق المجموعات واختيار الأوقات المناسبة.
          </p>
        </div>
